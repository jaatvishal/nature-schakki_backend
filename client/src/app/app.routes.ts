...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'audit', loadComponent: () => import('./features/admin/audit/audit.component').then(m => m.AdminAuditComponent) },
      { path: 'alerts', loadComponent: () => import('./features/admin/alerts/alerts.component').then(m => m.AdminAlertsComponent) },
    ],
  },
