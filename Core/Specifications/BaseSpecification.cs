...
public class BaseSpecification<T>(Expression<Func<T, bool>>? criteria) : ISpecification<T>
{
    ...
    public IQueryable<T> ApplyCritera(IQueryable<T> query)
    {
        if (Criteria != null)
        {
    ...
    protected void AddOrderDescending(Expression<Func<T, object>> orderByDescExpression) => OrderByDescending = orderByDescExpression;
